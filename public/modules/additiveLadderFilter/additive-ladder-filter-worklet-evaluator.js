// Worklet: Ladder Filter — warm spectral LP/BP/HP + Resonance, once per quantum.

NodeLiveAudioProcessor.prototype.additiveLadderFilterWorkletEvaluate = function additiveLadderFilterWorkletEvaluate(
  node, nodeId, frame,
) {
  if (frame !== 0) return;
