...
const nodeGraphModuleDefinitions = (
    ...
    parameters: [
      {
        ...
        nonlinearSlider: false,
        step: "1",
        tooltip: "Butterworth multipole (maximally flat). High-accuracy SOS for music; match lab software only if you need bit-level identity.",
      },
      {
        defaultValue: "1000",
        key: "frequency",
  ...
  crossover2: {
    ...
    inputLabels: { In: "Mono" },
    inputs: ["In", "Left", "Right"],
    outputs: ["Low Left", "Low Right", "High Left", "High Right"],
    parameters: [
      {
        defaultValue: "4",
        key: "order",
        ...
        nonlinearSlider: false,
        step: "2",
        tooltip: "Linkwitz-Riley order: 2 / 4 / 8 (about 12 / 24 / 48 dB/oct). LR4 is the usual default.",
      },
      {
        defaultValue: "1000",
        key: "frequency",
        ...
        step: "any",
        unit: "Hz",
        tooltip: "Crossover split frequency (enforced non-decreasing across splits).",
      },
    ],
  },
  crossover3: {
    ...
    inputLabels: { In: "Mono" },
    inputs: ["In", "Left", "Right"],
    outputs: ["Low Left", "Low Right", "Mid Left", "Mid Right", "High Left", "High Right"],
    parameters: [
      {
        defaultValue: "4",
        key: "order",
  ...
  crossover4: {
    ...
    inputLabels: { In: "Mono" },
    inputs: ["In", "Left", "Right"],
    outputs: ["Low Left", "Low Right", "Low-Mid Left", "Low-Mid Right", "High-Mid Left", "High-Mid Right", "High Left", "High Right"],
    parameters: [
      {
        defaultValue: "4",
        key: "order",
  ...
  crossover5: {
    ...
    inputLabels: { In: "Mono" },
    inputs: ["In", "Left", "Right"],
    outputs: ["Band 1 Left", "Band 1 Right", "Band 2 Left", "Band 2 Right", "Band 3 Left", "Band 3 Right", "Band 4 Left", "Band 4 Right", "Band 5 Left", "Band 5 Right"],
    parameters: [
      {
        defaultValue: "4",
        key: "order",
  ...
  crossover6: {
    ...
    inputLabels: { In: "Mono" },
    inputs: ["In", "Left", "Right"],
    outputs: ["Band 1 Left", "Band 1 Right", "Band 2 Left", "Band 2 Right", "Band 3 Left", "Band 3 Right", "Band 4 Left", "Band 4 Right", "Band 5 Left", "Band 5 Right", "Band 6 Left", "Band 6 Right"],
    parameters: [
      {
        defaultValue: "4",
        key: "order",
  ...
  // Period-reset chirp: sine sweeps each tooth, then schedule resets. Cheap “zap → buzz” voice.
  sinepulse: {
    planRole: "source",
    displayType: "lineBurn",
    displayModes: [
    ...
    parameters: [
      {
        ...
        unit: "Hz",
        tooltip:
          "Tooth / pulse rate (period = 1/f). Low = sweep kicks; high = saw-ish buzz. Default slider 0…20 kHz. Pitch MOD / f as usual.",
      },
      {
        defaultValue: "0.7",
        key: "sweep",
        ...
        step: "any",
        tooltip:
          "Chirp depth within each period. 0 = pure sine at Frequency; 1 = ±4 octaves of instant-frequency sweep (zap / failing-saw).",
      },
      {
        choices: ["Down", "Up"],
        defaultValue: "0",
        ...
        nonlinearSlider: false,
        step: "1",
        tooltip: "Down = high→low (classic zap kick). Up = low→high.",
      },
      {
        choices: ["Linear", "Exp"],
        defaultValue: "1",
        ...
        nonlinearSlider: false,
        step: "1",
        tooltip: "Instant-frequency law inside the tooth: linear Hz or exponential (musical octaves).",
      },
      {
        choices: ["Off", "On"],
        defaultValue: "1",
        ...
        nonlinearSlider: false,
        step: "1",
        tooltip: "On = zero the sine phase at each tooth (and Reset edge) for a sharper attack. Off = continuous phase.",
      },
      {
        defaultValue: "0",
        key: "phase",
  ...
  wallDelay: {
    ...
    parameters: [
      ...
      { control: "number", defaultValue: "6", key: "rayCount", label: "Rays", linearSmoothing: false, max: "16", maxDigits: 0, mid: "6", min: "1", nonlinearSlider: false, step: "1", tooltip: "Number of initial directions sampled from each ear (X). Total delay taps = Rays x Bounces." },
      { control: "number", defaultValue: "3", key: "bounceCount", label: "Bounces", linearSmoothing: false, max: "6", maxDigits: 0, mid: "3", min: "1", nonlinearSlider: false, step: "1", tooltip: "Number of wall bounces simulated per ray (Y). Total delay taps = Rays x Bounces." },
  ...
  soemReverb: {
    ...
    parameters: [
      ...
      { control: "number", defaultValue: "10", key: "numDelays", label: "Num Delays", max: "12", min: "0", step: "1" },
      ...
      { defaultValue: "2", key: "lpfStages", label: "LPF Stages", max: "5", min: "0", step: "1" },
      { defaultValue: "2", key: "bandStages", label: "Band Stages", max: "5", min: "0", step: "1" },
  ...
  videoscope: {
    ...
    parameters: [
      ...
      { key: "timeDivSamples", label: "Window Size", defaultValue: "512", min: "8", mid: "512", max: "8192", step: "1" },
      {
        choices: ["Run", "Freeze"],
        defaultValue: "0",
        displayChoices: true,
  ...
  matrixWaterfall: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Main residual fade (hot trail length). 0 = almost none; 1 = multi-second. For long dim burn-in ghosts use Burn.",
      },
      {
        key: "ghost",
        label: "Ghost",
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Dim scorched residual hang (screen burn-in). Not permanent, not peak brightness. Hot path length is Trail.",
      },
      {
        key: "spawn",
        label: "Spawn",
  ...
  matrixDisplay: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Main residual fade on glyph change. High = longer hot afterglow.",
      },
      {
        key: "ghost",
        label: "Ghost",
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Dim scorched residual hang. Not permanent. Hot path length is Trail.",
      },
      {
        choices: ["Off", "On"],
        defaultValue: "0",
  ...
  asciiscope: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Main residual length. 0 = dies immediately; 1 ≈ freeze-ish. Dim scorch is Ghost.",
      },
      {
        key: "ghost",
        label: "Ghost",
