  ...
  matrixWaterfall: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Screen burn-in simulation: long-lived low residual hang on top of Trail. Not permanent, not peak brightness.",
      },
      {
        key: "spawn",
        label: "Spawn",
  ...
  matrixDisplay: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Screen burn-in: long-lived dim residual hang on top of Trail. Not permanent.",
      },
      {
        choices: ["Off", "On"],
        defaultValue: "0",
  ...
  asciiscope: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Main residual fade. 0 = multi-second trails; 1 = short memory. Does not change brightness.",
      },
      {
        key: "burn",
        label: "Burn",
        ...
        step: "any",
        maxDigits: 4,
        tooltip: "Screen burn-in: long-lived dim residual hang on top of Decay. Not permanent, not peak brightness.",
      },
      {
        key: "brightness",
        label: "Brightness",
