...
const nodeGraphModuleDefinitions = (
  ...
  smoothGraph: {
    ...
    inputLabels: { In: "→", Code: "ðŸ“" },
    outputLabels: { Out: "←", Code: "ðŸ“" },
    layout: "graph",
    parameters: [
  ...
  additiveLinearFilter: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        outputDomain: true,
        tooltip: "Curve amount (âˆ’1â€¦+1). 0 = linear ramp in the Slope transition. Ignored as a separate 'Linear' mode — that is just Skew 0.",
      },
      {
  ...
  arp: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "1",
        unit: "oct",
        tooltip: "Transpose arpeggiated pitch by whole octaves (âˆ’4â€¦+4). Applied to ♯/♭ and Æ’ outs."
      },
      {
        defaultValue: "0",
        key: "sequenceOffset",
  ...
  chorus: {
    ...
    parameters: [
      ...
      },
      {
        ...
        min: "0",
        step: "any",
        tooltip: "Per-voice phase offset (i/N turns). 0 = all LFOs lock. Needed when Random Freq is 0.",
      },
      {
        defaultValue: "3.5",
        key: "frequency",
        ...
        step: "any",
        unit: "Hz",
        tooltip: "Shared vibrato Speed. f = Speed × (1 + sine × Top Morph).",
      },
      {
        curveAmount: "-0.7",
        defaultValue: "0",
        ...
        sliderCurve: "bipolarRational",
        step: "any",
        tooltip: "Shared AM Index into Speed.",
      },
      {
        curveAmount: "0.9",
        defaultValue: "0",
        ...
        sliderCurve: "edges",
        step: "any",
        tooltip: "Shared sine × Side Morph added to LFO phase (cycles).",
      },
      {
        defaultValue: "0",
        key: "phase",
  ...
  ensemble: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        unit: "ms",
        tooltip: "Base delay. time = Delay + modulator × Depth.",
      },
      {
        defaultValue: "3",
        key: "depth",
