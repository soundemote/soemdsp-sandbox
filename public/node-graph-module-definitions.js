const nodeGraphNodeLabels = Object.freeze({
  ...
  additiveAnalogFilter: "Butterworth Filter",
  additiveGrowl: "Growl",
...
const nodeGraphModuleDefinitions = (
  ...
  additiveLinearFilter: {
    ...
    chrome: "LayoutA",
    customDisplayArea: true,
    displayType: "additiveFilterCurve",
    displayHeightGu: 2,
    defaultWidthGu: 8,
    displayModes: [
    ...
    parameters: [
      {
        ...
        unit: "cycle",
        wraparound: true,
        tooltip: "Constant phase add on every harmonic (cycles).",
      },
      {
        defaultValue: "0",
        key: "phaseSkew",
        ...
        unit: "cycle",
        outputDomain: true,
        tooltip: "Hydrus Phase Skew in cycles (domain 0…1000, not normalized). DSP uses this number directly.",
      },
      {
        defaultValue: "0",
        key: "phaseSkewCurve",
        ...
        step: "any",
        outputDomain: true,
        tooltip: "Hydrus Phase Skew Curve (−1…+1). Shapes how skew grows across harmonics.",
      },
    ],
  },
  additiveNoisyFreq: {
    ...
    parameters: [
      {
        choices: ["CheapWalk", "CheapFilteredNoise", "WhiteNoise"],
        defaultValue: "0",
        displayChoices: true,
        divideChoicesVisibly: true,
        key: "noise",
  ...
  additiveNoisyPhase: {
    ...
    parameters: [
      ...
      },
      {
        ...
        min: "0",
        step: "any",
        tooltip: "Noise depth on harmonic phase (±Amount/2 cycles).",
      },
      {
        defaultValue: "35",
        key: "speed",
  ...
  additiveNoisyPan: {
    ...
    parameters: [
      ...
      },
      {
        ...
        min: "0",
        step: "any",
        tooltip: "Noise depth on harmonic pan (±Amount in −1…+1).",
      },
      {
        defaultValue: "35",
        key: "speed",
  ...
  additiveNoisyAmp: {
    ...
    parameters: [
      ...
      },
      {
        ...
        min: "0",
        step: "any",
        tooltip: "Noise depth on harmonic amplitude (±Amount/2, clamped 0…1).",
      },
      {
        defaultValue: "35",
        key: "speed",
  ...
  additiveOut: {
    ...
    parameters: [
      {
        choices: ["None", "Inaudible Harmonics"],
        defaultValue: "0",
        displayChoices: true,
        divideChoicesVisibly: true,
        key: "optimize",
        ...
        min: "0",
        step: "1",
        tooltip: "None = full quality (phase keeps running above Nyquist). Inaudible Harmonics = skip amp≤0 or hz≥Nyquist for CPU (phase may discontinuity if they return).",
      },
      {
        defaultValue: "100",
        key: "frequency",
