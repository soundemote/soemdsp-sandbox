...
const nodeGraphModuleDefinitions = (
  ...
  gain: {
    ...
    parameters: [
      ...
      },
      {
        ...
        nonlinearSlider: false,
        step: "1",
        tooltip: "How Left and Right become Mono Out. Sum = L+R. Average = (L+R)/2 (unity for dual-mono). Power = RMS with mid sign. Equal-power = (L+R)/√2. Peak = larger-magnitude channel. Left / Right = that channel only."
      },
      {
        defaultValue: "0",
        key: "offset",
  ...
  range: {
    ...
    parameters: [
      ...
      {
        // Defaults stay −10…+10; slider chrome allows ±20000 so Hz-range outs are editable.
        defaultValue: "-10",
        key: "outLow",
        label: "Out Low",
        max: "20000",
        ...
        showSign: true,
        step: "any",
        tooltip: "Output at In Low. Slider domain −20000…+20000 (defaults −10). Wire spawn still uses −1 or 0 as the value.",
      },
      {
        defaultValue: "10",
        key: "outHigh",
        ...
        showSign: true,
        step: "any",
        tooltip: "Output at In High. Slider domain −20000…+20000 (defaults +10). Wire spawn still uses +1 as the value.",
      },
    ]
  },
  softClipper: {
    ...
    parameters: [
      {
        ...
        smoothingSeconds: 0.0333,
        smoothingType: "linear",
        tooltip: "Bias value. Face shows and edits this. Swing + Smooth time live in Parameter Settings. Display Settings Look = Knob or Slider.",
      },
  ...
  // ISO 1/3-octave graphic EQ (30 peaking bands). Band knobs are unit −1…+1 × Range.
  graphicEq: {
    planRole: "processor",
    inputAliases: { Mono: "In" },
    inputLabels: { In: "Mono" },
    ...
    parameters: [
      {
        ...
        min: "0",
        step: "1",
        tooltip: "Peak boost/cut span. Band knobs are −1…+1 scaled by this range.",
      },
      {
        defaultValue: "1",
        key: "mix",
      ...
      { defaultValue: "0", key: "band0", label: "25", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "25 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band1", label: "31.5", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "31.5 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band2", label: "40", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "40 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band3", label: "50", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "50 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band4", label: "63", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "63 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band5", label: "80", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "80 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band6", label: "100", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "100 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band7", label: "125", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "125 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band8", label: "160", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "160 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band9", label: "200", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "200 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band10", label: "250", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "250 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band11", label: "315", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "315 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band12", label: "400", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "400 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band13", label: "500", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "500 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band14", label: "630", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "630 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band15", label: "800", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "800 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band16", label: "1k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "1000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band17", label: "1.25k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "1250 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band18", label: "1.6k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "1600 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band19", label: "2k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "2000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band20", label: "2.5k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "2500 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band21", label: "3.15k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "3150 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band22", label: "4k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "4000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band23", label: "5k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "5000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band24", label: "6.3k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "6300 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band25", label: "8k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "8000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band26", label: "10k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "10000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band27", label: "12.5k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "12500 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band28", label: "16k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "16000 Hz (−1…+1 × Range)." },
      { defaultValue: "0", key: "band29", label: "20k", max: "1", mid: "0", min: "-1", showSign: true, step: "any", tooltip: "20000 Hz (−1…+1 × Range)." },
      nodeGraphOutputAmplitudeParam,
    ],
  },
  ...
  // Chaosfly — dual sine FM chaos (JSFX Elan's Chaos Generator).
  chaosfly: {
    planRole: "source",
    planFreeRun: true,
    displayType: "scope2d",
  ...
  reverbEffect: {
    ...
    inputs: ["Mono", "Left", "Right"],
    inputLabels: { Mono: "Mono", Left: "Left", Right: "Right" },
    // Legacy long names → short Mix L/R / Dry L/R.
    outputAliases: {
      "Mix Left": "Mix L",
      "Mix Right": "Mix R",
      "Dry Left": "Dry L",
  ...
  // Brickwall Limiter — protective peak ceiling. Look-ahead optional (explicit delay, no host PDC).
  // Musical squash / pump → type `limiter` (Pump Limiter).
  lookaheadLimiter: {
    planRole: "processor",
    displayHeightGu: 3,
    displayType: "trace",
  ...
  expAdsr: {
    ...
    parameters: [
      ...
      },
      {
        ...
        nonlinearSlider: false,
        step: "any",
        tooltip: "Bipolar shape for decay and release. 0 = linear, + = exp, − = log."
      },
      {
        choices: ["Off", "On"],
        defaultValue: "0",
  ...
  // Retired — prefer Vactrol for simple optical A/R. Kept for old patches.
  attackDecay: {
    planRole: "processor",
    layout: "envelopeCurve",
    inputs: ["Gate"],
