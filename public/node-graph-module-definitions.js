const nodeGraphNodeLabels = Object.freeze({
  ...
  additiveAnalogFilter: "Analog Filter",
  additiveGrowl: "Growl",
  ...
  additiveLinearFilter: {
    ...
    parameters: [
      ...
      },
      {
        ...
        min: "0",
        step: "any",
        tooltip: "Where the slope / brickwall sits across the harmonic index (0…1).",
      },
      {
        defaultValue: "0.25",
        key: "slope",
        ...
        min: "0",
        step: "any",
        tooltip: "0 = brickwall, 1 = widest linear ramp.",
      },
    ],
  },
  additiveAnalogFilter: {
    ...
    parameters: [
      ...
      },
      {
        ...
        min: "0",
        step: "any",
        tooltip: "Where the nonlinear slope / brickwall sits (0…1).",
      },
      {
        defaultValue: "0.25",
        key: "slope",
        ...
        min: "0",
        step: "any",
        tooltip: "0 = brickwall, 1 = widest ramp.",
      },
      {
        defaultValue: "0",
        key: "skew",
        ...
        min: "-1",
        step: "any",
        tooltip: "Rational curve bend (−1…+1). 0 ≈ linear.",
      },
    ],
  },
  additiveGrowl: {
    ...
    parameters: [
      {
        ...
        unit: "cycle",
        wraparound: true,
        tooltip: "Constant phase add on every harmonic (SoEmAdditive PhaseRotation).",
      },
      {
        defaultValue: "0",
        key: "phaseSkew",
        ...
        min: "0",
        step: "any",
        tooltip: "Ramp step per harmonic (SoEmAdditive PhaseSkew).",
      },
      {
        defaultValue: "0",
        key: "phaseSkewCurve",
        ...
        min: "-1",
        step: "any",
        tooltip: "RationalS shape for the skew ramp (−1…+1).",
      },
    ],
  },
  additiveNoisyFreq: {
    ...
    parameters: [
      {
        ...
        min: "0",
        step: "any",
        tooltip: "How far each harmonic ratio walks.",
      },
      {
        defaultValue: "35",
        key: "speed",
    ...
    parameters: [
      {
        ...
        min: "0",
        step: "any",
        tooltip: "How far each harmonic phase walks (cycles).",
      },
      {
        defaultValue: "35",
        key: "speed",
    ...
    parameters: [
      {
        ...
        min: "0",
        step: "any",
        tooltip: "How far each harmonic pan walks (−1…+1).",
      },
      {
        defaultValue: "35",
        key: "speed",
    ...
    parameters: [
      {
        ...
        min: "0",
        step: "any",
        tooltip: "How far each harmonic amplitude walks (clamped 0…1).",
      },
      {
        defaultValue: "35",
        key: "speed",
