...
const nodeGraphModuleDefinitions = (
  ...
  additiveEffect: {
    ...
    parameters: [
      {
        choices: ["LinearFilter", "AnalogFilter", "Growl", "Noisy"],
        defaultValue: "0",
        displayChoices: true,
        divideChoicesVisibly: true,
        key: "effect",
      ...
      { defaultValue: "0.5", key: "parA", label: "ParA", max: "1", mid: "0.5", min: "0", step: "any",
        tooltip: "LinearFilter: slope span. AnalogFilter: cutoff (harmonic-ratio units). Growl: amount. Noisy: amount." },
      { defaultValue: "1", key: "parB", label: "ParB", max: "1", mid: "0.5", min: "0", step: "any",
        tooltip: "LinearFilter: cutoff index. AnalogFilter: slope 1…48 dB/oct. Growl: curve. Noisy: CheapWalk speed." },
      { defaultValue: "0", key: "parC", label: "ParC", max: "1", mid: "0.5", min: "0", step: "any" },
      { defaultValue: "0", key: "parD", label: "ParD", max: "1", mid: "0.5", min: "0", step: "any" },
    ],
  },
  additiveOut: {
    planRole: "source",
