const nodeGraphNodeLabels = Object.freeze({
  ...
  additiveCurveEnvelope: "Additive Envelope",
    ...
    parameters: [
      {
        ...
        linearSmoothing: false,
        smoothingType: "none",
        tooltip: "Integer partial count (1…1024). Snap changes; use Bubble Cutoff for fractional trailing fade.",
      },
      {
        choices: [
          "Saw",
  ...
  additiveBubble: {
    ...
    parameters: [
      ...
      },
      {
        ...
        step: "any",
        outputDomain: true,
        tooltip: "Bend the logarithmic phase cascade (−1…+1). 0 = linear. −/+ mirror; full negative travel is usable.",
      },
      {
        defaultValue: "1",
        key: "cutoff",
      ...
      },
      {
        ...
        unit: "cycle",
        outputDomain: true,
        tooltip: "0 = off (Phase Skew ignores Cutoff). >0 = as Cutoff→1, effective Phase Skew lerps toward this value (e.g. 10 → skew approaches 10 at full Cutoff).",
      },
    ],
  },
    ...
    parameters: [
      {
        ...
        min: "0",
        step: "1",
        tooltip: "On: snap each overtone to the nearest multiple of the fundamental (1×,2×,3×,…) or division (½×,¼×,…). Fund unchanged.",
      },
      {
        defaultValue: "0",
        ...
        step: "any",
        outputDomain: true,
        tooltip: "After quantize: add per-overtone unit-random × amount to ratio. 1 = exact random [0,1) cycles of ratio; 2 = twice that. Fund unchanged.",
      },
      {
        defaultValue: "1",
        key: "seed",
    ...
    parameters: [
      {
        ...
        min: "-1",
        step: "any",
        tooltip: "Odd/even stereo spread first. 0 = mono. +1 = even→hard L / odd→hard R. −1 = reversed. Gradual in between. Amps unchanged.",
      },
      {
        defaultValue: "0",
        key: "pan",
        ...
        min: "-1",
        step: "any",
        tooltip: "Crossfades the Width image toward one hard side. 0 = Width stereo as-is; +1 = all harmonics hard Right; −1 = all hard Left. With Width at 0, pans the mono image L/R.",
      },
    ],
  },
  additiveNoisyPan: {
