...
const nodeGraphLiveCombinedNativeModuleUrl = "native_modules/combined/soemdsp_combined.wasm?v=graph-engine-15";
...
const nodeGraphLiveWorkletSourceFiles = [
  ...
  "./public/node-live-audio-worklet-events.js?v=graph-engine-15",
  ...
  "./public/node-live-audio-worklet-native-exports.js?v=graph-engine-15",
  "./public/node-live-audio-worklet-native-graph.js?v=graph-engine-15",
  "./public/node-live-audio-worklet-set-plan.js?v=graph-engine-15",
  ...
  "./public/node-live-audio-worklet-process.js?v=graph-engine-15",
