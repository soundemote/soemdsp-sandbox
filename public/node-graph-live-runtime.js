...
const nodeGraphLiveCombinedNativeModuleUrl = "native_modules/combined/soemdsp_combined.wasm?v=robin-jitter-dual-ladder-sweep-1";
...
const nodeGraphLiveWorkletSourceFilesEfficient = [
  ...
  "./public/node-live-audio-worklet-native-graph.js?v=dual-ladder-sweep-1",
  ...
  "./public/modules/_shared/controller-efficient-sidecar.js?v=knob-smooth-3",
