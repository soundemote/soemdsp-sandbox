...
const nodeGraphLiveWorkletSourceFiles = [
  ...
  "./public/modules/portal/portal-math.js?v=portal-io-1",
  ...
  "./public/node-live-audio-worklet-dsp-state.js?v=hermite-1",
  ...
  "./public/node-live-audio-worklet-evaluators-processors.js?v=keypad-latch-1",
  ...
  "./public/node-live-audio-worklet-evaluate-frame.js?v=output-amp-1",
  ...
  "./public/modules/audioPlayer/audio-player-worklet-evaluator.js?v=player-phase-nudge-1",
