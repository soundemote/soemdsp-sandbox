...
const nodeGraphLiveCombinedNativeModuleUrl = "native_modules/combined/soemdsp_combined.wasm?v=bias-1";
...
const nodeGraphLiveWorkletSourceFilesEfficient = [
  ...
  "./public/node-graph-efficient-product.js?v=bias-1",
  ...
  "./public/node-live-audio-worklet-native-graph.js?v=bias-1",
