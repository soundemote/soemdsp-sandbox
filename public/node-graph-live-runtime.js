...
const nodeGraphLiveWorkletSourceFilesLegacy = [
  ...
  "./public/modules/additiveGraph/additive-graph-math.js?v=qfreq-lerp-1",
  ...
  "./public/modules/additiveQuantizeFreq/additive-quantize-freq-worklet-evaluator.js?v=qfreq-lerp-1",
