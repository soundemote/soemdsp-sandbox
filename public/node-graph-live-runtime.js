...
const nodeGraphLiveWorkletSourceFiles = [
  ...
  "./public/node-live-audio-worklet-evaluators-sources.js?v=sinepulse-rename-1",
  ...
  "./public/modules/scientificIir/scientific-iir-worklet-evaluator.js?v=theremin-uc-1",
  ...
  "./public/modules/sinepulse/sinepulse-math.js?v=sinepulse-16",
  "./public/modules/sinepulse/sinepulse-worklet-evaluator.js?v=sinepulse-16",
