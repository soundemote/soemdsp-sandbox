...
const nodeGraphLiveCombinedNativeModuleUrl = "native_modules/combined/soemdsp_combined.wasm?v=robin-1";
...
const nodeGraphLiveWorkletSourceFilesEfficient = [
  ...
  "./public/node-graph-efficient-product.js?v=robin-1",
  ...
  "./public/node-live-audio-worklet-native-graph.js?v=robin-1",
