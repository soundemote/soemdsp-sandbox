...
const nodeGraphLiveCombinedNativeModuleUrl = "native_modules/combined/soemdsp_combined.wasm?v=snap-controls-1";
...
const nodeGraphLiveWorkletSourceFilesEfficient = [
  ...
  "./public/node-graph-efficient-product.js?v=strip-foreign-1",
  ...
  "./public/node-live-audio-worklet-native-graph.js?v=wasm-plan-race-1",
