const nodeGraphEmojiCatalog = Object.freeze([
  ...
  },
  {
    ...
    label: "Audio",
    glyphs: [
      // Gate (held high) — digital pulse / rectangle
      "▮", "▯", "▬", "▭", "■", "□", "█", "▄", "▀", "⊓", "⊔",
...
const nodeGraphEmojiGlyphNames = Object.freeze({
  ...
  "³": "superscript three",
  "‰": "per mille",
  "▮": "black vertical rectangle (gate)",
  "▯": "white vertical rectangle (gate)",
  "▬": "black rectangle (gate hold)",
  "▭": "white rectangle (gate)",
  "■": "black square",
  "□": "white square",
  "█": "full block (gate)",
  "▄": "lower half block",
  ...
  "⊔": "square cup",
  "⎍": "monostable (pulse)",
  "▁": "lower one eighth block (scope low)",
  "▂": "lower one quarter block",
  "▃": "lower three eighths block",
  "▅": "lower five eighths block",
  "▆": "lower three quarters block (scope high)",
  "▇": "lower seven eighths block",
  "┌": "box down-right (square-wave corner)",
  "┐": "box down-left (square-wave corner)",
  "└": "box up-right (square-wave corner)",
  "┘": "box up-left (square-wave corner)",
  "│": "box vertical (edge)",
  "⚡": "lightning (trigger)",
