...
const nodeGraphTraceDisplayActiveControlsByType = Object.freeze({
  ...
  toggleButtonFace: Object.freeze({
    ...
    choices: Object.freeze(["buttonAlign", "labelAlign"]),
  }),
...
const nodeGraphDisplaySettingsFieldMeta = Object.freeze({
  ...
  buttonScale: Object.freeze({
    label: "Button scale",
    inputmode: "decimal",
    id: "nodeTraceDisplayButtonScale",
    title: "Button size 0…1 of the padded face.",
  }),
  textScale: Object.freeze({
    label: "Text scale",
    inputmode: "decimal",
    id: "nodeTraceDisplayButtonTextScale",
    title: "Off/On text size 0…1. 1 fills the button.",
  }),
  buttonPadding: Object.freeze({
    label: "Button pad",
    inputmode: "decimal",
  ...
  labelScale: Object.freeze({
    label: "Label scale",
    inputmode: "decimal",
    id: "nodeTraceDisplayButtonLabelScale",
    title: "Label font size 0…1 of the face min side.",
  }),
  hue: Object.freeze({
    label: "Hue",
    inputmode: "decimal",
