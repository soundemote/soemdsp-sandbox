...
| Per-module `*-math.js` | curveOsc, snowflake, rotate3dTo2d, vectorscopeTransform, gain, bias, gainBias, softClipper, comparator, sampleDelay, slewLimiter, inertialFilter, sampleHold, speedColorInertia, minMax, bitConverter, delayedTrigger |
