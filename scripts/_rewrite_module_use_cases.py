...
USE_CASES: dict[str, str] = {
  ...
  "passiveFilter": "Gentle 6 dB LP/HP/BP for soft cleanup and light tone shaping.",
  ...
  "activeFilter": "Scientific multipole ladder with optional drive—precise slopes plus bite.",
  ...
  "inertialFilter": "Exponential attack/release approach—smooth catch-up without hard slew corners.",
