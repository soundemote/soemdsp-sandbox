...
for pat, rep in [
  ...
  (r"modules/vactrol/vactrol-live-evaluator\.js\?v=[^\"]*", f"modules/vactrol/vactrol-live-evaluator.js?v={tag}"),
]:
  t = re.sub(pat, rep, t)
...
rt = re.sub(
  r"vactrol-worklet-evaluator\.js\?v=[^\"]*",
  f"vactrol-worklet-evaluator.js?v={tag}",
  rt,
)
