...
$modules = @(
  ...
  @{ Name = "fbm_field"; Simd = $false; Exports = @("soemdsp_fbm_field_create", "soemdsp_fbm_field_destroy", "soemdsp_fbm_field_reset", "soemdsp_fbm_field_sample", "soemdsp_fbm_field_x", "soemdsp_fbm_field_y", "soemdsp_fbm_field_x_raw", "soemdsp_fbm_field_y_raw", "soemdsp_fbm_field_version") }
