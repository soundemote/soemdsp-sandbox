...
$modules = @(
  ...
  @{ Name = "transport"; Simd = $false; Exports = @("soemdsp_transport_create", "soemdsp_transport_destroy", "soemdsp_transport_sample", "soemdsp_transport_reset", "soemdsp_transport_unipolar", "soemdsp_transport_frequency", "soemdsp_transport_click", "soemdsp_transport_version") }
  ...
  @{ Name = "ping_pong_delay"; Simd = $false; Exports = @(
    ...
    "soemdsp_ping_pong_delay_block_output_mod_left_ptr",
    "soemdsp_ping_pong_delay_block_output_mod_right_ptr",
    "soemdsp_ping_pong_delay_max_block_frames",
  ...
  @{ Name = "basic_shape"; Simd = $false; Exports = @(
    ...
    "soemdsp_basic_shape_out", "soemdsp_basic_shape_sine", "soemdsp_basic_shape_tri",
    "soemdsp_basic_shape_saw", "soemdsp_basic_shape_ramp", "soemdsp_basic_shape_square",
    "soemdsp_basic_shape_trisaw", "soemdsp_basic_shape_center_square",
    "soemdsp_basic_shape_phase",
  ...
  @{ Name = "voice_manager"; Simd = $false; Exports = @(
    ...
    "soemdsp_voice_manager_set_phony_mode", "soemdsp_voice_manager_set_slide_mode",
    ...
    "soemdsp_voice_manager_last_attack_slot", "soemdsp_voice_manager_last_event_kind",
    "soemdsp_voice_manager_polyphony", "soemdsp_voice_manager_version"
  ) },
