...
$modules = @(
  ...
  @{ Name = "air_clipper"; Simd = $false; Exports = @("soemdsp_air_clipper_create", "soemdsp_air_clipper_destroy", "soemdsp_air_clipper_sample", "soemdsp_air_clipper_version", "soemdsp_air_clipper_metadata_json", "soemdsp_air_clipper_metadata_json_size") }
